...
Reviews detailReview= (Reviews) request.getAttribute("detail");
String fullname= (String) request.getAttribute("User_name");
...
<html >
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/detailreview.css" />
        <link
            rel="stylesheet"
    ...
    <body>
        ...
        <div class="slider">
            ...
            <a href="productView" class="shop-btn">Shop Now</a>
                        ...
                        <div class="giua"><h2>Review Details</h2></div>
        ...
        <div class="center-container">
            <div class="review-detail">
                <h3>Name: <%= fullname %></h3>
                <h4>Title: <%= detailReview.getTitle() %> </h4>
                <p><strong>Review:</strong></p>
                <p><%= detailReview.getContent() %></p>
                <p><strong>Date:</strong> <%= detailReview.getReview_date() %></p>
            </div>
