...
<html>
    ...
    <body>
        ...
        <% } else if ("error_admin_access".equals(error)) { %>
            <script> showAlert1(); </script>
        <% } %>
        ...
        <div class="header">
            <div class="header__contact">
                ...
                <ul class="header__contact-info info-2">
                    <li class="header__contact-info-icon">
                        <i class="header__icon fa-regular fa-user"></i><a href ="login.jsp">
                            Log in</a>
                    </li>
                    <li class="header__contact-info-icon">
        ...
        <div class="slider">
            ...
            <div type = "hidden" id="login"> </div>
        </div>
                    <div class="baoquanh">
        <div class="login-container">
            <h2>Login</h2>
            <form name="loginForm" action="login" method="post" onsubmit="validateForm(event)">
                <label for="username">Username:</label>
                <input type="text" name="username" class="input-field" /><br />
                <span class="error-message" id="usernameError">Please enter the username!</span><br />

                <label for="password">Password:</label>
                <input type="password" name="password" class="input-field" /><br />
                <span class="error-message" id="passwordError">Please enter the password!</span><br />

                <input type="submit" value="Login" class="submit-button" />
            </form>
            <br>
            <a href="register.jsp#register" class="register-link">Register</a>
